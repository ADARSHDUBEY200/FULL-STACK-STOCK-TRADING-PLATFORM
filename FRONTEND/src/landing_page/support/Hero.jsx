...
function Hero() {
  return (
    <>
      ...
      <div className=" p-5 mt-3 bg-primary row " id="supportWrapper">
      ...
      <div className="row p-5 mb-3 bg-primary">
        <div className="col-6 p-3">
          <h1 className="fs-3 mb-5 text-white">
            Search for an answer or browse help topics to create a ticket
          </h1>
          <input placeholder="Eg. how do I activate F&O" className="m-3" style={{padding:"10px 15rem"}}/>
          <br />
